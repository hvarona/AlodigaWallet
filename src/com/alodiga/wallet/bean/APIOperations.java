...
public class APIOperations {
    ...
    public TopUpInfoListResponse getTopUpInfs(String receiverNumber, String phoneNumber) {
        ...
        //Toma de Base de datos el incremento sobre el retailPRice
...
//                topUpInfo.setAmount(Float.parseFloat(inf.getOpen_range_minimum_amount_local_currency()));
