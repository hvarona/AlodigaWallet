...
public class TopUpCountry implements Serializable {
    ...
    public TopUpCountry(Long id) {
        this.id = id;
    }

    public TopUpCountry(Long id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TopUpCountry)) {
            return false;
        }
        TopUpCountry other = (TopUpCountry) object;
