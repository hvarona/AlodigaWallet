...
public class TopUpResponseConstants {
    ...
    public static String TOP_UP = "TopUp";
    ...
    public static String PIN_IVR = "pin_ivr";
    public static String PIN_SERIAL = "pin_serial";
    public static String TUP_UP_AMOUNT = "top_up_amount";
    public static String TOP_UP_MOBILE_OPERATOR_ID = "top_up_mobilr_operator_id";
    public static String TOP_UP_MOBILE_OPERATOR_NAME = "top_up_mobilr_operato_name";
    ...
    static {
        ...
        aMap.put("105","Notenoughcreditonyouraccount");
        aMap.put("201","Transactionrefused");
        aMap.put("203","Transactionincomplete");
        aMap.put("204","DestinationAccountisnotprepaid");
        aMap.put("205","OriginatingAccountisnotprepaid");
        ...
        aMap.put("908","Account not configured for this service");
